<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityAdd.aspx.cs" Inherits="CXH.Web.ActivityAdd" %>
                ...
                <form class="layui-form" runat="server">
                 ...
                 <div class="layui-form-item">
                   ...
                   <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" name="username" required="" lay-verify="required" ID="txtsummary" runat="server"
                          autocomplete="off" class="layui-input">
                      </div>                     
                  </div>
                  <div class="layui-form-item">
                     ...
                     <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" name="username" ID="txtEndTime" required="" lay-verify="required" runat="server"
                          autocomplete="off" class="layui-input">
                      </div>                     
                  </div>
                  <div class="layui-form-item">
